...
// let count = +prompt("Введите количество чисел для вывода:");
...
// function squaresNumbers (min, max){
//     for (let i = min; i < max; i++) {
//         console.log(i * i);
//       }
// }

// squaresNumbers(0,100);
...
// const projectCount = prompt("Введите количество выполненных проектов (от 0 и выше");
...
//     const totalPrice = (priceRentDay * days) - totalDiscount;
  
//     console.log(`Стоимость аренды авто на ${days} дней: $${totalPrice}`);
//   }
